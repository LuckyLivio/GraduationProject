...
主系统方向继续，算法机制根据证据调整。本轮冻结三个已训练模型，比较从不校准、始终校准、门控校准与匹配历史的局部物理辨识；检验整体变化、局部变化、恢复和噪声。早期 `research-plan.md` 等文档保留当时计划，实际已实现范围和差异以本 README、工作记录与各批实验协议为准。
